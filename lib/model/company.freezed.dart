...
class _$_Company implements _Company {
  ...
  @override
  String toString() {
    return 'Company(id: $id, name: $name, number: $number, address: $address, city: $city, image: $image, instagram: $instagram, openingHours: $openingHours, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, number, address, city,
      image, instagram, openingHours, createdAt, updatedAt);
